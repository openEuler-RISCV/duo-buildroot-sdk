...
add_library(MILKVDUOL  STATIC "${GUEST_SRCS}")
...
####以下为make install打包脚本#####
set(milkvduol_riscv64_export modules)
...
set(INSTALL_MILKVDUOL_RISCV64_BASE_DIR                 .)
set(INSTALL_MILKVDUOL_RISCV64_INCLUDE_DIR              UniProton/include)
set(INSTALL_MILKVDUOL_RISCV64_INCLUDE_SEC_DIR          libboundscheck/include)
set(INSTALL_MILKVDUOL_RISCV64_ARCHIVE_DIR              UniProton/lib/milkvduol)
set(INSTALL_MILKVDUOL_RISCV64_ARCHIVE_SEC_DIR          libboundscheck/lib/milkvduol)
set(INSTALL_MILKVDUOL_RISCV64_ARCHIVE_CONFIG_DIR       UniProton/config)
set(INSTALL_MILKVDUOL_RISCV64_CONFIG_DIR               cmake/milkvduol)


include(CMakePackageConfigHelpers)
configure_package_config_file(${PROJECT_SOURCE_DIR}/cmake/tool_chain/milkvduol_riscv64_config.cmake.in
	${CMAKE_CURRENT_BINARY_DIR}/uniproton-milkvduol-riscv64-config.cmake
	INSTALL_DESTINATION ${INSTALL_MILKVDUOL_RISCV64_CONFIG_DIR}
	PATH_VARS
	INSTALL_MILKVDUOL_RISCV64_BASE_DIR
	INSTALL_MILKVDUOL_RISCV64_INCLUDE_DIR
	INSTALL_MILKVDUOL_RISCV64_INCLUDE_SEC_DIR
	INSTALL_MILKVDUOL_RISCV64_ARCHIVE_DIR
	INSTALL_MILKVDUOL_RISCV64_ARCHIVE_SEC_DIR
	INSTALL_MILKVDUOL_RISCV64_ARCHIVE_CONFIG_DIR
	INSTALL_MILKVDUOL_RISCV64_CONFIG_DIR
	INSTALL_PREFIX ${CMAKE_INSTALL_PREFIX}
)
install(EXPORT ${milkvduol_riscv64_export}
		NAMESPACE UniProton::
		FILE uniproton-milkvduol-riscv64-targets.cmake
		DESTINATION ${INSTALL_MILKVDUOL_RISCV64_CONFIG_DIR}
)
install(FILES
	${CMAKE_CURRENT_BINARY_DIR}/uniproton-milkvduol-riscv64-config.cmake
	DESTINATION ${INSTALL_MILKVDUOL_RISCV64_CONFIG_DIR}
...
if (${COMPILE_OPTION} STREQUAL "coverity" OR ${COMPILE_OPTION} STREQUAL "fortify" OR ${COMPILE_OPTION} STREQUAL "UniProton")
    ...
    if (NOT "${RPROTON_INSTALL_FILE_OPTION}" STREQUAL "SUPER_BUILD")
        ...
        install(FILES
            ${glob_sec_files}
            DESTINATION ${INSTALL_MILKVDUOL_RISCV64_INCLUDE_SEC_DIR}
        )
    endif()
endif()
...
install(TARGETS
	MILKVDUOL
	EXPORT ${milkvduol_riscv64_export}
	ARCHIVE DESTINATION ${INSTALL_MILKVDUOL_RISCV64_ARCHIVE_DIR}/
)
...
install(FILES
	${PROJECT_SOURCE_DIR}/build/uniproton_config/config_riscv64_milkvduol/prt_buildef.h
	DESTINATION ${INSTALL_MILKVDUOL_RISCV64_ARCHIVE_CONFIG_DIR}/riscv64/milkvduol
)
...
if (NOT "${LIBCK_INSTALL_FILE_OPTION}" STREQUAL "SUPER_BUILD")
	...
	install(FILES
		...
		DESTINATION ${INSTALL_MILKVDUOL_RISCV64_ARCHIVE_CONFIG_DIR}
	)
	##{GLOB 所有文件 | GLOB_RECURSE 递归查找文件&文件夹}
	file(GLOB common_include_files  ${PROJECT_SOURCE_DIR}/src/include/uapi/*.h)
	install(FILES
		${common_include_files}
		DESTINATION ${INSTALL_MILKVDUOL_RISCV64_INCLUDE_DIR}
	)
	...
	install(FILES
		...
		DESTINATION ${INSTALL_MILKVDUOL_RISCV64_INCLUDE_DIR}/hw/riscv64
	)
