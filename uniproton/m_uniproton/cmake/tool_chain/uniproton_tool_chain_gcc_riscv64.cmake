...
set(CMAKE_C_COMPILE_OBJECT "<CMAKE_C_COMPILER> -O0  -mcmodel=medany  -g ${COMPILE_WARING_FLAG}     -Wno-error=incompatible-pointer-types -Wno-error=pointer-to-int-cast -Wno-error=int-to-pointer-cast -march=rv64gc -mabi=lp64d -static -fno-PIE   -fomit-frame-pointer -fzero-initialized-in-bss  -fno-common -fno-stack-protector  -funsigned-char -fno-PIC  <FLAGS> <INCLUDES> -c <SOURCE> -o <OBJECT>")
else()
...
set(CMAKE_C_COMPILE_OBJECT "<CMAKE_C_COMPILER>  -mcmodel=medany ${COMPILE_WARING_FLAG}     -Wno-error=incompatible-pointer-types -Wno-error=pointer-to-int-cast -Wno-error=int-to-pointer-cast -march=rv64gc -mabi=lp64d -static -nostdlib -nostartfiles -nodefaultlibs  -fno-builtin -fno-PIE   -fomit-frame-pointer -fzero-initialized-in-bss   -fno-common -fno-stack-protector  -funsigned-char -fno-PIC  <FLAGS> <INCLUDES> -c <SOURCE> -o <OBJECT>")
endif()
