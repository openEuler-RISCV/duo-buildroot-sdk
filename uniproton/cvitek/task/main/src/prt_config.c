...
{
    U32 ret;
    printf("OsSysConfigReg start!!\n");
    ret = OsSystemReg();
    if (ret != OS_OK) {
        return ret;
    }
    printf("OsSysConfigReg end!!\n");
    return OS_OK;
}
