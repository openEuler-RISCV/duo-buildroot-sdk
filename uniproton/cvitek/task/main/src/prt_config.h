...
/* ***************************** 配置系统基本信息 ******************************* */
/* 芯片主频 */
#define OS_SYS_CLOCK                                    configSYS_CLOCK_HZ
/* 用户注册的获取系统时间的函数*/
...
#define OS_TICK_PER_SECOND                              10000000
...
/* 最大支持的任务数,最大共支持254个 */
#define OS_TSK_MAX_SUPPORT_NUM                          128
/* 缺省的任务栈大小 */
...
/* 私有FSC内存分区起始地址 */
#define OS_MEM_FSC_PT_ADDR                              (uintptr_t)(ucHeap)
/* 私有FSC内存分区大小 */
#define HEAP_SIZE					0x88500
#define OS_MEM_FSC_PT_SIZE                              HEAP_SIZE
